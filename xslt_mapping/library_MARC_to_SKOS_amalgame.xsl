...
<xsl:template match="collection">
    <rdf:RDF>
		<rdf:Description rdf:about="http://hdl.handle.net/10934/RM0001.SCHEME.TOPIC_TERM">
...
<xsl:template match="subfield[@code = '0']">
    <xsl:attribute name="rdf:resource">
        ...
        <xsl:text>http://hdl.handle.net/10934/RM0001.</xsl:text>
        <!-- NL-AmRIJ seems to commonly be replaced by NLAmRIJ -->
        <xsl:value-of select="substring-after(.,'(NL-AmRIJ)')"/>
        <xsl:value-of select="substring-after(.,'(NLAmRIJ)')"/>
    </xsl:attribute>
</xsl:template>
